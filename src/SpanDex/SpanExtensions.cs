...
namespace SpanDex.Extensions {
    public static class SpanExtensions {
        ...
        public static byte ReadByte(this ReadOnlySpan<byte> source, ref int cursor) => SpanReading.ReadByte(source, ref cursor);
        ...
        public static bool TryReadByte(this ReadOnlySpan<byte> source, out byte value, ref int cursor) => SpanReading.TryReadByte(source, out value, ref cursor);
        ...
        public static byte ReadByte(this Span<byte> source, ref int cursor) => SpanReading.ReadByte(source, ref cursor);
        ...
        public static bool TryReadByte(this Span<byte> source, out byte value, ref int cursor) => SpanReading.TryReadByte(source, out value, ref cursor);
        ...
        public static bool TryWriteByte(this Span<byte> destination, byte value, ref int cursor) => SpanWriting.TryWriteByte(destination, value, ref cursor);
        ...
        public static void WriteByte(this Span<byte> destination, byte value, ref int cursor) => SpanWriting.WriteByte(destination, value, ref cursor);
    }
}
